...
import com.bitchat.android.onboarding.WelcomePreferenceManager
...
import com.bitchat.android.ui.SimpleMainScreen
...
class MainActivity : OrientationAwareActivity() {
    ...
    private var showWelcomeOnLaunch = false
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        showWelcomeOnLaunch = !WelcomePreferenceManager.isComplete(this)
                ...
                Scaffold(
                    ...
                    if (showWelcomeOnLaunch) {
                        WelcomeScreen(
                            ...
                            onContinue = {
                                WelcomePreferenceManager.markComplete(this@MainActivity)
        ...
        if (!showWelcomeOnLaunch && mainViewModel.onboardingState.value == OnboardingState.CHECKING) {
            checkOnboardingStatus()
        }
    }
    ...
    private fun OnboardingFlowScreen(modifier: Modifier = Modifier) {
        ...
        when (onboardingState) {
            ...
            OnboardingState.CHECKING, OnboardingState.INITIALIZING, OnboardingState.COMPLETE -> {
                SimpleMainScreen(viewModel = chatViewModel)
            }
